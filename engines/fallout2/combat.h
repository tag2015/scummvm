#ifndef FALLOUT2_COMBAT_H
#define FALLOUT2_COMBAT_H
...
static inline bool isUnarmedHitMode(int hitMode) {
	return hitMode == HIT_MODE_PUNCH || hitMode == HIT_MODE_KICK || (hitMode >= FIRST_ADVANCED_UNARMED_HIT_MODE && hitMode <= LAST_ADVANCED_UNARMED_HIT_MODE);
}
